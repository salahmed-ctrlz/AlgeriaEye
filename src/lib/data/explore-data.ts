...
export const CLOTHING_ITEMS: ExploreItem[] = [
    ...
    },
    {
        ...
        title_ar: "المجوهرات الجزائرية",
        title_fr: "Bijoux Algériens",
        subtitle: "Silver & Coral",
        subtitle_ar: "الفضة والمرجان",
        subtitle_fr: "Argent & Corail",
        image: "/images/explore/accessory_dz12.jpg",
        region: "Beni Yenni / Aurès",
        region_ar: "بني يني / الأوراس",
        region_fr: "Beni Yenni / Aurès",
        description: "Traditional silver jewelry adorned with coral and enamel, symbols of protection and identity.",
        description_ar: "مجوهرات فضية تقليدية مزينة بالمرجان والمينا، رموز للحماية والهوية.",
        description_fr: "Bijoux traditionnels en argent ornés de corail et d'émail, symboles de protection et d'identité.",
        history: "Algerian jewelry is an ancestral art. In Beni Yenni (Kabylia), silver is enamelled with blue, green, and yellow. In the Aurès, heavy silver anklets (khelkhal) are worn. These pieces are often passed down through generations.",
        history_ar: "المجوهرات الجزائرية فن متوارث. في بني يني (القبائل)، تطلى الفضة بالمينا الأزرق والأخضر والأصفر. في الأوراس، يتم ارتداء الخلخال الفضي الثقيل. غالباً ما تنتقل هذه القطع عبر الأجيال.",
        history_fr: "La bijouterie algérienne est un art ancestral. À Beni Yenni (Kabylie), l'argent est émaillé de bleu, vert et jaune. Dans les Aurès, de lourdes chevillères en argent (khelkhal) sont portées. Ces pièces sont souvent transmises de génération en génération.",
